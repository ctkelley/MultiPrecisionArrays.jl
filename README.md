...
__The half precision lu is much faster as of v0.0.3. Look at _src/Factorizations/hlu_ to see the hack job I did to [generic_lu](https://github.com/JuliaLang/julia/blob/master/stdlib/LinearAlgebra/src/lu.jl).__
