...
function greensEvsH(n = 31)
    ...
    errok = (e16 == ee16)
    histok = (norm(h16 - he16, Inf) < 1.0e-14)
    histok || println("he16 - h17 error  ", norm(he16 - h16, Inf))
    EvsHok16 = (errok && histok)
    EvsHok16 || println("TF=F16: heavy IR and expensive IR differ")
    ...
    errok = (abs(e3216 - ee3216) < 1.0e-6)
    histok = (h3216 == he3216)
    histok = (norm(he3216 - he3216, Inf) < 1.0e-14)
